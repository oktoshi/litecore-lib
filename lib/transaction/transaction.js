...
Transaction.MAX_MONEY = 105000000 * 1e8; // Okcash top 105M coins
...
Transaction.FEE_PER_KB = 10000; // Okcash default fees is 0.0001 OK
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' Use Transaction#uncheckedSerialize if you want to skip security checks. ' +
      'See http://okcore.io/guide/transaction.html#Serialization for more info.';
 ...
 * and a slightly fancier format recognized by okcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a okcore Address object. The
 * same is true for `script`, which can be a string or a okcore Script.
 *
